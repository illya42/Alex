...
create table recherche
	(
		...
		natureRecherche enum("location","achat") not null,
...
create table bienImmobilier
	(
		...
		dispoLocation enum("disponible", "indisponible") not null,
		dispoAchat enum("disponible", "indisponible") not null,
...
insert into recherche values
			(1,1,"paris","0","900","location"),
			(2,2,"paris","0","500000","achat"),
			(3,3,"lyon","0","750000","achat");

insert into mandat values
			(1,"oui","non","non","non"),
			(2,"non","oui","non","non"),
			(3,"non","non","non","oui");

insert into bienImmobilier values
			(1,1,"15 rue de gentilly","lyon","disponible","disponible","850","450000"),
